...
disaster <- read.csv("original/disaster.csv")
#a. Use the filter() function to subset the data set to only include years 2000–2019 and the disaster types “Earthquake” and “Drought”
